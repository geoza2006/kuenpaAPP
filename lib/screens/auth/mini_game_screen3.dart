...
class MiniGameScreen3 extends StatefulWidget {
  const MiniGameScreen3({super.key});

  @override
  State<MiniGameScreen3> createState() => _MiniGameScreenState();
}

class _MiniGameScreenState extends State<MiniGameScreen3> {
  // สถานะเริ่มต้นคือกำลังเล่น
  GameState _gameState = GameState.playing;

  final String questionImage = 'assets/images/game_turtle.jpg';
  final String correctAnswer = 'เต่าตนุ';
  
  // ตัวเลือกและสีของปุ่ม
  final List<Map<String, dynamic>> options = [
    {'text': 'เต่าหัวค้อน', 'color': const Color(0xFFFC8F93)},    // สีชมพูอมแดง
    {'text': 'เต่าหญ่า', 'color': const Color(0xFF90F585)},    // สีเขียวอ่อน
    {'text': 'เต่าตนุ', 'color': const Color(0xFFFBFD89)},  // สีเหลืองอ่อน
    {'text': 'เต่ามะเฟือง', 'color': const Color(0xFFFF8BFF)}, // สีม่วงชมพู
  ];
